        ...
        <div className="w-full max-w-sm">
          ...
          >
            <div>
              ...
              <div>
                <label className="font-[dana] mb-2 mt-4 block">
                  آدرس ایمیل
                </label>
                <input
                  id="email-address"
              ...
              <div>
                <label
                  htmlFor="password"
                  className="font-[dana] mb-2 mt-4 block"
                >
                  رمزعبور
                </label>
                <input
            ...
            <div className="mt-12 mb-5">
              <button
                ...
                className="flex w-full justify-center rounded-[8px] bg-indigo-600 py-2.5 text-[15px] font-[dana] text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition-colors"
              >
                ورود
              </button>
            </div>
            <p className="text-center text-sm text-gray-500 font-[dana] text-[13px] md:text-[14px]">
              ...
              <Link
                href="/auth/register"
                className="text-blue-600 hover:text-blue-500 font-[dana] text-[14.5px]"
              >
                ثبت نام
              </Link>
            </p>
