  ...
  return (
    <div>
      <div className="block md:hidden">
        <header className="w-full bg-white dark:bg-zinc-800 dark:text-zinc-200 text-zinc-700 px-3 py-2 cursor-default font-[dana]">
          <div
            id="menu"
            className="hidden w-[260px] fixed right-0 top-0 h-screen bg-zinc-100 dark:bg-zinc-800/90"
          >
            <span>
              <svg
          ...
          <div className="flex justify-between items-center">
            <div>
              <div className="flex items-center gap-x-2">
                ...
                <span className="text-[14px]">لوگو سایت</span>
              </div>
            </div>
            <div className="flex items-center gap-x-3">
              ...
              <div className="flex items-center gap-x-2 dark:bg-blue-700/20 dark:hover:bg-blue-700 bg-blue-600 hover:bg-blue-700 transition-colors px-2 py-1 rounded-md cursor-pointer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="24px"
                  viewBox="0 -960 960 960"
                ...
                <span className="hidden sm:inline-block">سبدخرید</span>
              </div>
              {isLoggedIn ? (
                <div>
                  <Link href="/dashbord">
                    <div className="flex items-center gap-x-2 text-zinc-100 font-[morabba] dark:bg-green-700/30 dark:hover:bg-green-600 bg-green-500 hover:bg-green-600 transition-colors px-2 py-1 rounded-md">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        height="24px"
                        viewBox="0 -960 960 960"
      ...
      <div className="invisible h-.5 md:hidden block"></div>
    </div>
  );
}
